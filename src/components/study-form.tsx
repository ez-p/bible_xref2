                ...
                >
                  ...
                  <div className="flex flex-col gap-2 text-sm">
                    <ol className="list-decimal space-y-1.5 pl-4 text-muted-foreground">
                      ...
                      <li>
                        A full study guide is generated by referencing the passage context, the
                        cross-references, and optional study question. Key themes, application, and
                        discussion questions are generated from the Bible passages.
                      </li>
                      <li>
                    ...
                    <p className="text-muted-foreground">
                      ...
                      question will be woven throughout the output. Get creative to generate unique
                      and interesting studies using the study question!
                    </p>
                  </div>
                  <DialogFooter>
